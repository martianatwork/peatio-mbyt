RSpec.describe Peatio::Mbyt::Wallet do
  let(:wallet) { Peatio::Mbyt::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Mbyt::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Mbyt::Wallet::SUPPORTED_SETTINGS))
    end
  end
